...
/// Spacing constants for consistent UI layout across the app.
///
/// Use these named constants instead of magic numbers so spacing is
/// consistent and easy to update project-wide.
///
/// spacing 2 - smallest spacing step used for very tight gaps.
const double spacing2 = 2;

/// spacing 4 - extra-small spacing for compact layouts.
const double spacing4 = 4;

/// spacing 8 - small spacing used for compact gaps.
const double spacing8 = 8;

/// spacing 12 - medium-small spacing.
const double spacing12 = 12;

/// spacing 16 - standard spacing used widely across the UI.
const double spacing16 = 16;

/// spacing 20 - slightly larger spacing for light separation.
const double spacing20 = 20;

/// spacing 24 - large spacing for grouping sections.
const double spacing24 = 24;

/// spacing 32 - extra-large spacing for major separations.
const double spacing32 = 32;

/// spacing 48 - extra-large spacing for major separations.
...
/// insets with `spacing2` on all sides.
const allInsets2 = EdgeInsets.all(spacing2);
